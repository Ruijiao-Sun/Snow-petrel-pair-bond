...
save(out1,file = "SPbs_0_F.RData")

writeMat("SP0bs_F_mean.mat",F_mean=out1$mean)
writeMat("SP0bs_F_lower.mat",F_lower=out1$q2.5)
writeMat("SP0bs_F_upper.mat",F_upper=out1$q97.5)
