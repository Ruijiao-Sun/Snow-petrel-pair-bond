...
out1 <- jags(jags.data, inits, parameters, "SP_1.txt", n.chains = nc, n.thin = nt, n.iter = ni, n.burnin = nb, parallel = TRUE)

save(out1,file = "SPbs_1_F.RData")

writeMat("SP1bs_F_mean.mat",F_mean=out1$mean)
writeMat("SP1bs_F_lower.mat",F_lower=out1$q2.5)
writeMat("SP1bs_F_upper.mat",F_upper=out1$q97.5)
