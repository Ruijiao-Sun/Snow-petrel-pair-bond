...
save(out1,file = "SPbs_1_M.RData")

writeMat("SP1bs_M_mean.mat",M_mean=out1$mean)
writeMat("SP1bs_M_lower.mat",M_lower=out1$q2.5)
writeMat("SP1bs_M_upper.mat",M_upper=out1$q97.5)
